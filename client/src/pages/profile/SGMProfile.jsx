...
import {
  ...
  Target, Mail, ChevronLeft, ChevronRight, CalendarDays,
  Phone, X
} from 'lucide-react';
  ...
  return (
    <div className="h-screen w-screen antialiased flex overflow-hidden" style={{ background: 'var(--k-white)', fontFamily: 'Poppins, sans-serif' }}>
      ...
      <main className="flex-1 overflow-y-auto k-scroll">
        ...
        <Band tone="white" eyebrow="Manager identity">
        ...
        <EditProfileModal
          ...
          onUpdate={(updatedData) => {
            ...
            setUserProfile(prev => ({
              ...
              role: updatedData.role === "SGM" ? "Senior General Manager" : (updatedData.role || prev.role),
        ...
        {isInfoModalOpen && (
          <div className="k-backdrop z-[300]" onClick={() => setIsInfoModalOpen(false)}>
            <div className="k-modal !max-w-2xl" onClick={(e) => e.stopPropagation()}>
              <div className="flex items-center justify-between border-b px-6 py-5 md:px-8" style={{ borderColor: 'var(--k-grey-200)' }}>
                <h2 className="text-2xl font-bold tracking-tight" style={{ color: 'var(--k-ink)' }}>SGM Information</h2>
                <button
                  type="button"
              ...
              <div className="p-6 md:p-10 space-y-6 overflow-y-auto k-scroll">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div className="k-card-grey p-4">
                    ...
                    <p className="font-semibold" style={{ color: 'var(--k-ink)' }}>{userProfile.name || 'N/A'}</p>
                  </div>
                  <div className="k-card-grey p-4">
                    <p className="k-eyebrow mb-1">Role</p>
                    <p className="font-semibold" style={{ color: 'var(--k-ink)' }}>{userProfile.role || 'N/A'}</p>
                  </div>
                  <div className="k-card-grey p-4">
                    <p className="k-eyebrow mb-1">Email</p>
                    <p className="font-semibold break-all" style={{ color: 'var(--k-ink)' }}>{userProfile.email || 'N/A'}</p>
                  </div>
                  <div className="k-card-grey p-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="k-card-static p-4 text-center">
                    <p className="k-eyebrow">Employees</p>
                    <p className="text-xl font-bold tabular-nums" style={{ color: 'var(--k-blue)' }}>
