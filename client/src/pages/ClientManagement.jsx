...
const ClientCard = ({ data, onEdit, onDelete, onToggleStatus, canToggleStatus }) => {
  ...
  return (
    <div
      ...
      className="group relative bg-white rounded-[2rem] p-6 hover:shadow-2xl hover:shadow-slate-200/50 border border-slate-100 hover:border-[#F58A4B]/30 transition-all duration-300 cursor-pointer flex flex-col gap-6 h-full"
    >
