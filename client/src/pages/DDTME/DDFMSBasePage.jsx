    ...
    >
      ...
      <div className="flex items-center justify-between mt-8 relative z-10">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-slate-50 rounded-xl group-hover:bg-indigo-600 group-hover:text-white transition-all"
        >
          <span className="text-[10px] font-black uppercase tracking-widest">Open DDFMS</span>
