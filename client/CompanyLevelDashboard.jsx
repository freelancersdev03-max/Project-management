        ...
        <div className="flex h-screen overflow-hidden" style={{ background: 'var(--k-white)', fontFamily: 'Poppins, sans-serif' }}>
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <motion.header
                    ...
                    className="k-band-white px-5 md:px-8 py-4 flex flex-wrap items-center justify-between gap-3 border-b z-10"
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <div className="flex items-center gap-2">
                                <h1 className="text-lg md:text-xl font-bold" style={{ color: 'var(--k-ink)' }}>
                                    Company <span style={{ color: 'var(--k-blue)' }}>Dashboard</span>
                                </h1>
                                <span className="k-live-dot" />
                            </div>
                            <p className="text-xs mt-0.5" style={{ color: 'var(--k-grey-500)' }}>
                ...
                <main className="flex-1 overflow-y-auto k-scroll">
                    ...
                    {/* ── BAND 2 · GREY · KPI counters ─────────────────── */}
                    <section className="k-band-grey k-band-pad">
                        <p className="k-eyebrow mb-3">Overview</p>
                        {loading ? (
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-3">
                                <KpiCard index={0} label="Total task" value={stats.totalTasks} icon={<LayoutGrid />} accent />
                                <KpiCard index={1} label="On time" value={stats.onTimeCompletion} icon={<CheckCircle2 />} accent />
                                <KpiCard index={2} label="In progress" value={stats.inProgress} icon={<TrendingUp />} />
                                <KpiCard index={3} label="Delayed" value={stats.delayed} icon={<Clock />} />
                                <KpiCard index={4} label="Overdue" value={stats.overdue} icon={<AlertCircle />} />
                                <KpiCard index={5} label="ATS score" value={stats.atsScore} icon={<Award />} suffix="%" decimals={1} accent />
                            </div>
                        )}
                    </section>

                    {/* ── BAND 3 · WHITE · Distribution + client filter ── */}
                                    ...
                                    {['All Tasks', ...clients.map(c => c.company_name)].map((name, i) => {
                                        ...
                                        return (
                                            <motion.label
                                                ...
                                                className="flex items-center gap-3 cursor-pointer group rounded-lg px-2.5 py-2 transition-colors"
                                                style={{ background: checked ? 'var(--k-blue-tint)' : 'transparent' }}
                                            >
                                                <input
                                                    type="checkbox"
                    ...
                    {/* ── BAND 4 · GREY · Employee performance ─────────── */}
                    <section className="k-band-grey k-band-pad">
                        <div className="flex flex-wrap items-center justify-between gap-2 mb-4">
                            <h2 className="k-section-title">Employee performance</h2>
                            {performerRows[0] ? (
                                <span
